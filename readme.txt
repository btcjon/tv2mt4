...
- If the command is "long" and the 'Trend' is "up" AND the 'State Long' is "closed" (or if CHECK_STATE is False), AND SnR field is NOT "Resistance", a "long" command is sent.
- If the command is "short" and the 'Trend' is "down" and the 'State Short' is "closed" (or if CHECK_STATE is False), AND SnR field is NOT "Support" a "short" command is sent.
